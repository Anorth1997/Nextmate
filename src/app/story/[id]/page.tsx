				...
				>
					...
					<>
						...
						<div className="absolute bottom-10 w-full">
							<div className="mx-4 flex h-16 items-center justify-center rounded-full bg-custom-purple-005 text-lg text-white">
								{hasStory && (
									<div
										className=""
								...
								{!hasStory &&
									...
									story.diamond != 0 && (
										<div className="" onClick={handleAddStory}>
											Unlock Story by {story.diamond} diamond
										</div>
									)}
								{!hasStory && condition && (
									// TODO 优化条件显示逻辑
									<div className="" onClick={handleShowConditions}>
										?
									</div>
								)}
								{!condition && (
