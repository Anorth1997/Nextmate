...
const Lottery: React.FC = () => {
	...
	const handleCollect = async () => {
		setShowLotteryCard(false);
		saveLotteryRecord(account?.id, lotteryType, selectedReward);
	};
				...
				<div className="relative z-20 flex h-64 w-64 flex-col items-center justify-center rounded-lg">
					{stage === 1 ? (
						...
						<>
							...
							>
								<img src={'/img/diamond.png'} width={30} height={30} />
								500
							</button>
							<button
